...
- **Client matcher listed [redacted] as active.** `clientMention.js:27-34` hardcoded [redacted]/[redacted]/[redacted]/[redacted]. Wildmountains was absent entirely. **117 backend files still mention [redacted].**
...
1. **`clientMention.js` patched.** SHIPPED 2026-05-18 - [redacted] out, Wildmountains/Goodreach/Sidequests in.
...
6. **[redacted] deep sweep across remaining 117 files** - PLANNED (separate fork).
...
6. **`archived-client-sweep-must-touch-code-not-just-dossier-2026-05-18`** - 117-file [redacted] lesson.
