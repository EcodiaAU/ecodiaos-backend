...
| 7 | bitbucket_event | **DEFER** | Same shape as github_event but [redacted]-specific. Pair it with #6 in a single design pass — auth context already provisioned at kv_store.creds.bitbucket_api_token. |
