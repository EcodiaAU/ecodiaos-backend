...
- **Stack.** Whatever ReachOut already runs (almost certainly a modern JS/TS stack, probably React/Next.js + a Node or Python backend + Postgres). Match their patterns, don't impose ours. Same discipline as [redacted] work — `~/CLAUDE.md` "Working in their architecture" rules apply.
