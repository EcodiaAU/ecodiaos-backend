...
- `~/ecodiaos/patterns/forks-do-their-own-recon-do-not-probe-on-main.md` - the recon fork should have surfaced the Google Workspace SPF / TXT clue before the forwarder pivot was even drafted.
