...
- `~/ecodiaos/patterns/pre-stage-fork-briefs-before-session-killing-ops.md` - prevention. If you know a restart is imminent, pre-stage the brief so the post-restart cron fires against a known artefact, not a flying cold-start.
