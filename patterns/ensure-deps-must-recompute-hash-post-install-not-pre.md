...
- `~/ecodiaos/patterns/no-pm2-restart-during-active-factory-queue.md` — auto-restart was firing while forks/factory sessions were in flight; this rule says don't pm2-restart during active queues, but here the restart was self-issued by the api itself in a loop, beneath conscious control
