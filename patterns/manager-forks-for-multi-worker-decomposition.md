...
1. **Brief carries `MANAGER: true`.** First non-blank line of the brief, or anywhere prominent — the spawner pattern-matches the literal token. The brief also explains the decomposition: "spawn N sub-forks, one per <unit-of-work>, then consolidate."
