...
Cross-ref: `~/ecodiaos/patterns/cron-prompts-must-respect-autonomous-pilot-sms-gate.md` - the autonomous-pilot-window form of the same principle (suppress routine SMS when Tate has explicitly declared he's away/asleep, allow critical-breakage SMS through).
