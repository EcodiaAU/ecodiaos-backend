triggers: pdf-only, no-markdown, no-html, deliverable-format, tate-pdf, audit-pdf, report-pdf, polish-list-pdf, render-pdf, /api/docs/render, downloadPdf, doc-output, document-format, no-md, no-html-output, tate-deliverable-format
