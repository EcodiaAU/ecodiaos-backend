---
triggers: drive-chrome-via-input, browser.*, browser.navigate, browser.enableCDP, input.click, input.type, input.shortcut, taskbar-click, click-chrome-icon, native-gui-automation, port-9222, default-profile, tate-chrome, no-spawn-chrome, no-kill-chrome, just-click-the-icon, gui-first-chrome, drive-chrome, open-chrome, win-1, super-key, ctrl-l, address-bar, no-puppeteer-default, drive chrome, open chrome, tate's chrome, tate chrome, screenshot tate's chrome, screenshot tate's browser, click chrome, click on chrome, click on stripe, click on vercel, click on bitbucket, click on supabase, click on xero, click on canva, click on zernio, click on github, click on appstore connect, click on asc, click on play console, click on firebase, click on resend, type into chrome, navigate chrome, address bar, vercel dashboard, stripe dashboard, supabase dashboard, xero web, canva editor, zernio dashboard, play console, gcp console, firebase console, resend dashboard, bitbucket web, github web, app store connect web, drive saas ui
---
