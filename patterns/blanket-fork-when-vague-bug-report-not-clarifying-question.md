...
This is a special case of `~/ecodiaos/patterns/_archived/decide-do-not-ask.md`, `~/ecodiaos/patterns/_archived/forks-do-their-own-recon-do-not-probe-on-main.md`, and `~/ecodiaos/patterns/minimize-tate-approval-queue.md`, but specifically for the bug-report shape that triggers a clarification reflex.
...
- `~/ecodiaos/patterns/_archived/decide-do-not-ask.md` (parent rule)
...
- `~/ecodiaos/patterns/_archived/stop-asking-just-decide.md` (general permission-seeking rule)
