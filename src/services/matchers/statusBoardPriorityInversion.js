...
/**
 * perceptionDispatcher matcher: status_board_priority_inversion
 *
 * Source: drafts/proposed-matchers/status_board_priority_inversion.js (W2 gap analysis).
...
module.exports = {
  ...
  async dispatch(event) {
    try {
      ...
      logger.debug('perceptionDispatcher: status_board_priority_inversion dispatch failed', { error: err.message })
    }
  },
}
