...
// ─── Anomaly Detection + Broadcast ─────────────────────────────────

const _anomalyCooldowns = new Map()
const ANOMALY_BROADCAST_COOLDOWN_MS = 5 * 60 * 1000
const CRITICAL_ANOMALY_COOLDOWN_MS = 60 * 1000
...
async function broadcastHealthAnomaly(anomalies, selfHealth) {
  ...
  // Broadcast to WebSocket so frontend sees it immediately
  try {
