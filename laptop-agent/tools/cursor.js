...
function ahkActivate() {
  ...
  // Matches the vscode.js working pattern: SetTitleMatchMode 2 + concat-string
  // form. The direct "ahk_exe Cursor.exe" single-string form fails in this
  // context for reasons not yet root-caused; the concat form works.
