...
// vscode.command_palette - Ctrl+Shift+P, type command, optionally Enter.
async function commandPalette(params) {
  ...
  return { ok: true, ide: params.ide || 'cursor', action: 'command_palette', command: command, submitted: params.submit !== false }
}
