...
| **Apple / ASC** | code@ecodia.au Apple ID, Ecodia Code team `86PUY7393S`. ASC app id `6760897574`. Universal SY094 driver at `~/asc-scripts/ship-ios.py` reads `apps/coexist.json` for marketing_version + asv_id. |
| **Google Play** | Published under code@ Play Console developer account. Signing key `android/app/coexist-release.jks`, passwords in `COEXIST_KEYSTORE_PASSWORD` + `COEXIST_KEY_PASSWORD` env vars (also in `kv_store.creds.coexist` android section). |
...
- Invoices:
  ...
  - INV-2026-003 (May 2026, $1,410.20 incl GST) sent 6 May (gmail msg id `19dffa931a0f2cfd`). v2 PDF at `documents/invoices/inv-coexist-2026-003-FINAL-v2-2026-05-07.pdf`.
  - INV-2026-004 (Jun 2026, projected $1,608.20 incl GST with current 3hrs MS365) auto-draft 2026-06-07.
  - INV-2026-005 (Jul 2026) auto-draft 2026-07-07. Last invoice of current retainer arc.
