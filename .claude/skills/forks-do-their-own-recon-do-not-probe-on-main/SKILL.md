---
name: forks-do-their-own-recon-do-not-probe-on-main
description: >
  Use when the turn involves spawn_fork, fork-recon, pre-dispatch-probe, brief-padding, codebase-probe-on-main, schema-probe-on-main, pre-fork-investigation, fork-vs-main, exhaustive-brief, brief-bloat, dont-probe-on-main, let-the-clone-do-it, fork-misuse, conductor-doing-doer-work, recon-on-main. Pattern: Forks do their own recon. Do not probe on main before dispatching..
---
