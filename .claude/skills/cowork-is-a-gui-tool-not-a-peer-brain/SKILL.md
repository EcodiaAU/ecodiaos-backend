---
name: cowork-is-a-gui-tool-not-a-peer-brain
description: >
  Use when the turn involves cowork-is-tool-not-brain, cowork-not-peer-brain, conductor-stays-in-loop, cowork-bounded-step-instruct, cowork-not-autonomous, cowork-screenshot-and-decide, who-is-the-brain, conductor-brain-cowork-hands, cowork-substrate-clarifier, gui-tool-not-agent-substrate. Pattern: Cowork is a GUI tool, not a peer brain - the conductor stays in the loop.
---

# Cowork is a GUI tool, not a peer brain - the conductor stays in the loop
