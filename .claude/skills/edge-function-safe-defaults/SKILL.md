---
name: edge-function-safe-defaults
description: >
  Use when the turn involves edge-function, supabase-edge-function, default-param-write, missing-param-mutate, write-endpoint-default, edge-function-idempotency, deno-serve. Pattern: Edge Function defaults must be safe - never write on a missing param.
---
