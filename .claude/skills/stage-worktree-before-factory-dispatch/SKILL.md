---
name: stage-worktree-before-factory-dispatch
description: >
  Use when the turn involves (no explicit triggers — surfaces via semantic match on title). Pattern: Stage or commit drafts BEFORE dispatching Factory.
---
