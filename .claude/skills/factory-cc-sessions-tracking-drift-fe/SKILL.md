---
name: factory-cc-sessions-tracking-drift-fe
description: >
  Use when the turn involves cc_sessions, tracking-drift, factory-fe, factory-frontend, files_changed-empty, confidence-misleading, factory-review, [redacted]-fe, coexist-fe, fe-worktree, phantom-vs-real, dispatcher-hard-gate, factory-attribution. Pattern: cc_sessions tracking drift on Factory FE dispatches — confidence + files_changed are unreliable. Inspect the worktree..
---
