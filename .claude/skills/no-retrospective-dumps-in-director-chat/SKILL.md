---
name: no-retrospective-dumps-in-director-chat
description: >
  Use when the turn involves retrospective, summary, lesson-learned, today-i-learned, pattern-emerged, doctrine-summary, narration, director-chat-pollution, long-message, recap, today's-discipline, pattern-is-clear, four-failures, ledger, day's-running, self-reflection-in-chat, post-action-summary, multi-paragraph-self-analysis. Pattern: Director chat is for actions and decisions. Retrospectives go in doctrine files. Period..
---
