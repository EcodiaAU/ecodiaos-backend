---
name: verify-empirically-not-by-log-tail
description: >
  Use when the turn involves pm2-logs, log-tail, log-capture, listener-audit, listener-loaded, empirical-verification, infrastructure-state, infra-audit, listeners-not-firing, listener-not-loaded, log-stopped, stdout-capture, trust-data-not-logs, system-state, audit-running-process. Pattern: Verify infrastructure state empirically, not by log-tail.
---
