---
name: exhaust-laptop-route-before-declaring-tate-blocked
description: >
  Use when the turn involves tate-blocked, next_action_by-tate, last-resort, 5-point-check, exhaust-laptop-route, browser-saved-credential, corazon-route, passkey-2fa, web-credential-walled, signed-in-session, tate-required, escalate-to-tate, blocked-on-tate, default-defer, ask-tate, classify-blocker, apple-team-id, asc-id-lookup, vendor-portal-login, tate-laptop-default-profile, gui-macro-route. Pattern: Exhaust the laptop + browser + saved-credential route before declaring anything Tate-blocked.
---
