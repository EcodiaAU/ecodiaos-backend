---
name: sms-segment-economics
description: >
  Use when the turn involves sms, twilio, send_sms, mcp__sms__send_sms, sms-cost, segment, 160-chars, 70-chars, sms-concise, sms-to-tate, outbound-sms, text-tate, sms-length. Pattern: SMS segment economics — be concise, stay under one segment.
---
...
```
[[redacted]] PR212 audit: 6/7 Eugene nits 100% fixed in code. 1 test drift found - line 125 still sends useCognito. Details in chat.
```
...
- Lead with a `[TAG]` prefix for quick triage: `[[redacted]]`, `[VPS]`, `[URGENT]`, `[CASH]`, `[FACTORY]`
