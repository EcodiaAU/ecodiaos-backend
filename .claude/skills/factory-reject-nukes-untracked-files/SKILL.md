---
name: factory-reject-nukes-untracked-files
description: >
  Use when the turn involves reject_factory_session, factory-reject, untracked-files, git-reset, worktree-clean, untracked-loss, dirty-worktree-dispatch, pre-dispatch-commit, factory-cleanup, factory-untracked-deleted. Pattern: Always commit pre-existing untracked files BEFORE dispatching Factory.
---
