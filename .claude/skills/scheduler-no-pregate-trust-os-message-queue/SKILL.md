---
name: scheduler-no-pregate-trust-os-message-queue
description: >
  Use when the turn involves schedulerPollerService, isTateActive, scheduler-defer, cron-defer, cron-skip, cron-not-firing, scheduler-active-window, tate-active-gate, scheduler-pre-gate, queue-vs-fire, idle-initialise, cron-initialisation. Pattern: Scheduler must not pre-gate on isTateActive - trust /api/os-session/message to queue or initialise.
---
