---
name: audit-infrastructure-for-false-embodiment-dependencies
description: >
  Use when the turn involves embodiment, false-dependency, tate-active, self-stamp, autoimmune, gate, scheduler-gate, defer-loop, authority-boundary, source-field, agent-self-distinction, ecodiaos-vs-tate, signal-attribution. Pattern: Audit Infrastructure for False-Embodiment-Dependencies.
---
