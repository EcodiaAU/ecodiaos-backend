---
name: verify-deployed-state-against-narrated-state
description: >
  Use when the turn involves verify-deployed-state, narrate-vs-disk, narration-unreliable, ground-truth-probe, shipped-claim-verify, deployed-claim-verify, live-claim-verify, merged-claim-verify, fixed-claim-verify, in-production-claim-verify, prod-url-curl, vercel-deploy-probe, supabase-row-probe, kv-store-read-after-write, factory-approve-probe, status-board-claim-probe, drift-from-disk, narration-drift-meta-rule, six-substrate-probe-checklist. Pattern: Verify deployed state against narrated state - narration is unreliable evidence.
---
