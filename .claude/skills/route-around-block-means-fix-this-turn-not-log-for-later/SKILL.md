---
name: route-around-block-means-fix-this-turn-not-log-for-later
description: >
  Use when the turn involves tool-unavailable, route-around, accept-not-fix, fix-this-turn, log-as-fix, defer-as-fix, P1-row-as-fix, follow-through, blocked, broken, after-current-deliverables, deferred-fix, status-board-as-procrastination, log-and-defer, three-strikes-29-apr-2026. Pattern: Acting on the route-around-the-block rule means fixing it THIS TURN, not logging it as a P1 row for later.
---
