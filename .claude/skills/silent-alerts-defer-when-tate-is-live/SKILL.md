---
name: silent-alerts-defer-when-tate-is-live
description: >
  Use when the turn involves silent-loop-detector, sms-tate, alert-tate, tate-active, tate-live, dead-mans-switch, cron-during-conversation, sms-rate-limit, alert-mute, noise-reduction, in-session-sms. Pattern: Silent-alert SMS defers when Tate is live in the OS session.
---
