---
name: verify-monitoring-query-schema-before-declaring-broken
description: >
  Use when the turn involves monitoring, observability, telemetry, feature-verification, zero-results, extracted_at, extracted_by, write-time-extraction, tier-4a, tier-4b, tier-4c, kg-extraction, false-alarm, schema-drift, observer-bug, broken-feature, probe-first, neo4j-property-name. Pattern: Verify the monitoring query schema before declaring a feature broken.
---
