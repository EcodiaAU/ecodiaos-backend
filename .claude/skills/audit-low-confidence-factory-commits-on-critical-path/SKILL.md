---
name: audit-low-confidence-factory-commits-on-critical-path
description: >
  Use when the turn involves factory-low-confidence, factory-confidence-0.4, factory-critical-path-audit, kv_store-accessor, sessionHandoff, mock-vs-production, test-mock-hides-bug, jsonb-vs-text, postgres-type-mismatch, second-attempt-fix, cold-start-recovery, factory-quality-gate, factory-audit-window. Pattern: Audit low-confidence Factory commits within 24h on critical-path files.
---
