---
name: external-blocker-freshness-probe
description: >
  Use when the turn involves next_action_by=external, external-blocker, stale-external-blocker, GST-blocker, ATO-blocker, ABR-blocker, Apple-Paid-Apps, ASIC-blocker, IRS-blocker, blocker-drift, blocked-on-external, external-freshness-probe. Pattern: External-blocker freshness probe - any external-blocked status_board row idle >14 days needs a real-world verification.
---
