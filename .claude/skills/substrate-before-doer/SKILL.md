---
name: substrate-before-doer
description: >
  Use when the turn involves phantom_session, repeat_failure, substrate, infra_bug, same_shape, factory_phantom, scheduler_eat, mcp_route_mismatch, ladder_failed_twice, third_dispatch. Pattern: Substrate before doer - when failures repeat in shape, suspect the floor before the ceiling.
---
