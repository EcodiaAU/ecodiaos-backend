---
name: discovery-to-doctrine-same-turn
description: >
  Use when the turn involves discovery-to-doctrine, CLAUDE.md-update, claude-md-reflection, factory-cli-paywall, tool-broken-doctrine, workaround-supersedes, operational-reality-write, credential-rotation-doctrine, mcp-schema-change, fresh-session-needs, doctrine-deferred-write, doctrine-same-turn. Pattern: Discovery to doctrine in one turn — operational realities land in CLAUDE.md the turn they emerge.
---
