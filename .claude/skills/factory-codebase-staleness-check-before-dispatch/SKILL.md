---
name: factory-codebase-staleness-check-before-dispatch
description: >
  Use when the turn involves factory-dispatch, start_cc_session, codebase-staleness, worktree-stale, behind-origin, divergent-base, fe-dispatch, frontend-factory, ecodiaos-frontend, rebase-conflict, unmergeable-commit, stale-clone, codebases-registry. Pattern: Factory codebase-staleness check before dispatch.
---
