---
name: listener-pipeline-needs-five-layer-verification
description: >
  Use when the turn involves listener, listener-subsystem, dbBridge, pg_notify, pg_trigger, eos_listener_events, listener-not-firing, dark-listener, wired-but-dark, end-to-end-verification, producer-trigger-listener, subsystem-audit, emailArrival, forkComplete, statusBoardDrift, factorySessionComplete, invoicePaymentState, listener-shipping. Pattern: Listener pipelines need 5-layer end-to-end verification, not just any single layer.
---
