---
name: continuous-work-conductor-never-idle
description: >
  Use when the turn involves conductor-standby, conductor-idle, free-time, fork-running-wait, no-immediate-work, day-plan, pipeline-advancement, doctrine-sweep, claude-md-self-audit, conductor-going-quiet, narration-not-action, fork-then-wait. Pattern: Continuous work - the conductor never goes idle.
---
