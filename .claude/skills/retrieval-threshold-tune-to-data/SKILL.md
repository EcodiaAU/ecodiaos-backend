---
name: retrieval-threshold-tune-to-data
description: >
  Use when the turn involves retrieval-threshold, semantic-search-tuning, vector-search, min-score, relevant-memory-injection, cold-start-warmup, retrieval-telemetry, graphrag, cortex-memory, node_embeddings, threshold-default. Pattern: Tune retrieval thresholds to the actual corpus, not to a default number.
---
