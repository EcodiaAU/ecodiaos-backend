---
name: positive-synthesis-pattern-authoring
description: >
  Use when the turn involves positive-synthesis, pattern-authoring, sunday-synthesis, doctrine-cadence, generalisation, weekly-reflection, claude-md-reflection, inner-life. Pattern: Author patterns from positive synthesis on cadence, not only from failure.
---
