...
description: >
  Use when the turn involves client-push, bitbucket-push, github-push, fireauditors1, ordit, client-repo, authorised-branch, pr-212, authorised-pr, client-contact-boundary, greenlight-scope, no-client-contact-without-tate-goahead, scope-envelope, delayed-push, symbolic-waiting. Pattern: Push to an authorised client PR branch is the WORK, not client contact. Do not gate it behind a per-commit greenlight..
---
