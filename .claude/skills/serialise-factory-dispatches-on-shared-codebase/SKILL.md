---
name: serialise-factory-dispatches-on-shared-codebase
description: >
  Use when the turn involves factory-dispatch, start_cc_session, parallel-factory, concurrent-factory, worktree-collision, factory-phantom-session, ecodiaos-backend, shared-codebase, dispatch-ordering, get_factory_status, serialise-dispatch. Pattern: Serialise all Factory dispatches on a shared codebase — concurrent sessions collide via worktree.
---
