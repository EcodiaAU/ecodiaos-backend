---
name: visual-verify-is-the-merge-gate-not-tate-review
description: >
  Use when the turn involves visual-verify-merge-gate, vercel-preview-ready, fork-pr-merge, gh-pr-merge, fork-pr-approval, awaiting-tate-review, visual-verification-ship, screenshot-pr, corazon-pr-verify, laptop-agent-pr. Pattern: Visual verification is the merge gate. Tate is NOT in the approve loop..
---
...
- Log in with stored client credentials (kv_store: `creds.coexist`, `creds.[redacted]`, etc.).
