---
name: neo4j-first-context-discipline
description: >
  Use when the turn involves neo4j-first-orientation, session-restart, kv_store-handoff, handoff_state, stale-state, retrieval-discipline, decision-vs-episode, cold-start, auto-wake, before-acting, after-directive, turn-open, turn-close, neo4j-vs-kv_store. Pattern: Neo4j-first context discipline.
---
...
1. Identify the topic keywords. (e.g. "client comms", "force param", "[redacted] auth", "Factory deploy".)
...
2. If the decision is tied to a Person (Tate), Client ([redacted], Co-Exist, etc.), or System (Factory, Neo4j, etc.), create a relationship via `graph_create_relationship`.
