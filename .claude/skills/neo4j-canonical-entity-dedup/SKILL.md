---
name: neo4j-canonical-entity-dedup
description: >
  Use when the turn involves neo4j-dedup, knowledge-graph-consolidation, neo4j-merge, canonical-entity-merge, embedded-label, kgConsolidationService, exact-name-match, duplicate-nodes, neo4j-cross-label, cortex-memory. Pattern: Canonical-entity dedup must merge same-name nodes across different labels.
---
