---
name: vercel-subdomain-rewrite-loop
description: >
  Use when the turn involves vercel-redirect-loop, redirect-loop, too-many-redirects, ERR_TOO_MANY_REDIRECTS, vercel-subdomain, code.ecodia.au, x-matched-path, middleware-rewrite, 307-loop. Pattern: Vercel subdomain rewrite + page redirect = infinite loop.
---
