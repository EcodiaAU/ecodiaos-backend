---
name: mcp-tool-param-schema-discipline
description: >
  Use when the turn involves mcp, mcp-server, gmail_archive, gmail_trash, gmail_mark_read, gmail_modify_labels, message_id, messageIds, missing-required-param, unknown-param, param-name, singular-vs-plural, schema-discipline, zod-required, parameter-aliasing. Pattern: Read the actual Zod schema before retrying any MCP call that fails on a parameter name.
---
