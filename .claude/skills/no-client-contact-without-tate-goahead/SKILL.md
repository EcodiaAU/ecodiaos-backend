---
name: no-client-contact-without-tate-goahead
description: >
  Use when the turn involves client email, client comms, reply to client, client-facing email, [redacted], eugene, [redacted], vikki, angelica, kurt, client-contact, external-counterparty-contact, no-client-contact, forwarded-from-tate, unilateral-client-contact, client-bitbucket-comment, zernio-client-dm. Pattern: Zero unilateral client contact - Tate authorises every client-facing message.
---
...
Applies to every client, every counterparty, every communication channel. Not just [redacted]. Not just Eugene. All of them. Default = silence from me, Tate relays.
