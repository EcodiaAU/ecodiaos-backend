---
name: ordit-prepush-pipeline
description: >
  Use when the turn involves ordit, prepush, push-to-ordit, bitbucket, scope-check, semgrep, pre-submission, client-push, fireauditors1, ordit-pr, reviewer-persona, pre-review, authorised-push. Pattern: Ordit pre-push pipeline — scope-check + semgrep + reviewer-persona loop.
---
