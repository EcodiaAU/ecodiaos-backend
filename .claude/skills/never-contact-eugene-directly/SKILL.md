---
name: never-contact-eugene-directly
description: >
  Use when the turn involves eugene, [redacted], [redacted], [redacted], [redacted], PR 212, [redacted] review, [redacted] comms. Pattern: Never contact Eugene (or any [redacted] technical contact) directly - Tate handles all human-side comms.
---
...
The only [redacted] surfaces I drive unilaterally: git push to our branch, Bitbucket PR comments that answer a direct technical question Eugene left on the PR. Everything else goes through Tate.
...
- CC Eugene on anything (that's Tate's call per [redacted] conventions)
...
## Origin
2026-04-21 22:59 AEST. Restart-recovery state mentioned "[redacted] PR 212 Eugene re-review if time" in my active plan. Tate flagged: "You dont ever contact eugene, only i do." Rule codified before any contact happened, no incident to clean up. Applies to all [redacted] contacts (Eugene technical, [redacted] billing) - any outbound comms goes through Tate.

Related: ~/CLAUDE.md "[redacted] / [redacted] Pty Ltd - Conventions" block already names CC convention for Tate's emails to [redacted]. This pattern extends that: I never initiate.
