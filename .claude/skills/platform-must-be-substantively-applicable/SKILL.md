---
name: platform-must-be-substantively-applicable
description: >
  Use when the turn involves platform-pitch, peak-body-pitch, landcare-pitch, cetin-pitch, conservation-platform-pitch, white-label-rebrand, platform-applicability, platform-fit, platform-tier, prospective-tenant, tenant-deployment, multiplier-thesis, working-name-pending, substantive-applicability. Pattern: The platform must be substantively applicable to target orgs, not just rebranded.
---
