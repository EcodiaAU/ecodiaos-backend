---
name: cron-fire-responses-do-not-emit-applied-tags-as-chat-output
description: >
  Use when the turn involves cron-fire, applied-tag, chat-pollution, director-chat-noise, telemetry-tag-not-chat-output, scheduled-task-response, no-tag-on-cron-response, applied-tag-belongs-in-telemetry-not-chat, fork-nudge-acknowledgement, scheduled-task-tag-leak, post-action-tag-discipline, tag-as-chat-noise. Pattern: `[APPLIED]` / `[NOT-APPLIED]` tags belong in tool dispatch text, NEVER in chat reply text the human director sees.
---
