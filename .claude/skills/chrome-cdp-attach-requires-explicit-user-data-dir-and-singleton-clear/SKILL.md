---
name: chrome-cdp-attach-requires-explicit-user-data-dir-and-singleton-clear
description: >
  Use when the turn involves chrome-cdp, enableCDP, browser.navigate, devtools-9222, port-9222, browser-attach, puppeteer-connect, SingletonLock, user-data-dir, chrome-debug-port, cdp-not-binding, browser-tool-failed-to-attach, json-version-unavailable, do-not-de-elevate, restore-last-session, multi-account-chrome, profile-directory. Pattern: Chrome CDP attach: --remote-debugging-port alone is not enough. You also need explicit --user-data-dir AND cleared SingletonLock..
---
