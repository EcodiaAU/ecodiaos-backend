---
name: coexist-vs-platform-ip-separation
description: >
  Use when the turn involves co-exist-ip, coexist-ip, kurt-charity, coexist-vs-platform, peak-body-pitch, landcare-pitch, multiplier-thesis, conservation-platform, white-label-rebrand, platform-tenant-0, ecodia-platform-IP, working-name-pending. Pattern: Co-Exist app belongs to Kurt; the platform underneath is ours - keep the IP separation explicit.
---
