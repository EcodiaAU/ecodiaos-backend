---
name: cowork-passkey-stall-conductor-injects
description: >
  Use when the turn involves cowork-passkey-stall, windows-hello, passkey-autofill, cowork-refuses-passkey, conductor-injects-passkey, two-bodies-one-mind, cowork-capability-ceiling, hello-prompt-detected, kv-store-laptop-passkey, anthropic-safety-constraint, co-pilot-capability-composition. Pattern: When Cowork stalls on Windows Hello, the conductor injects the passkey via input.type.
---
