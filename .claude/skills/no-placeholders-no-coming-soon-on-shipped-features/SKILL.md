---
name: no-placeholders-no-coming-soon-on-shipped-features
description: >
  Use when the turn involves placeholder, coming soon, stub, lorem, mock, fake data, dummy, todo, fully implemented, no placeholders, ship quality, complete feature, scycc, chambers, matt, tate-ship-quality, every feature. Pattern: Every shipped feature is fully implemented. No placeholders, no "coming soon.".
---
