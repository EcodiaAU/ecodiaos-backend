---
name: frontend-strip-model-xml-tags
description: >
  Use when the turn involves frontend-chat-render, model-xml-tags, scaffold-tag-strip, analysis-tag, thinking-tag, scratchpad-tag, reasoning-tag, reflection-tag, ReactMarkdown, rehypeRaw, TextBlock, model-output-sanitise, escaped-angle-brackets. Pattern: Strip / collapse model XML-style scaffold tags before rendering chat content.
---
