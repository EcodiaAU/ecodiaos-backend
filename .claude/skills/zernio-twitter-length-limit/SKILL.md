---
name: zernio-twitter-length-limit
description: >
  Use when the turn involves zernio, twitter, x, crosspost, post-too-long, social-media-queue, zernio-create-post, multi-platform-publish, tweet-280-chars, publish-failed, partial-status. Pattern: Zernio crosspost: posts over ~250 chars fail on Twitter/X and will not be auto-threaded.
---
