---
name: multi-tenant-brief-must-enumerate-customisation-surface
description: >
  Use when the turn involves multi-tenant-brief, multitenant-brief, white-label-brief, per-tenant-customisation, customisation-surface, tenant-brand, tenant-theming, multi-tenant-scope-inversion, chambers-federation, platform-brief-scope, PER-TENANT-CUSTOMISATION. Pattern: Multi-tenant briefs MUST enumerate the per-tenant customisation surface area.
---
