---
name: xero-oauth-redirect-uri-mismatch
description: >
  Use when the turn involves xero, xero-oauth, xero-callback, redirect-uri, oauth-404, xero-tokens, bank-feeds, bookkeeping-pipeline, finance-callback, oauth-silent-fail. Pattern: Xero OAuth fails silently when redirect URI mismatches mounted route.
---
