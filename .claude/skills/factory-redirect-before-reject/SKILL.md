---
name: factory-redirect-before-reject
description: >
  Use when the turn involves reject_factory_session, resume_cc_session, send_cc_message, factory-phantom-session, redirect-first, factory-redirect, factory-correction, in-flight-correction, factory-completed-wrong, factory-ladder. Pattern: Redirect Factory before reject - reject is the last rung, not the first.
---
