---
name: macros-record-mode-and-auto-author-from-runs
description: >
  Use when the turn involves macro, macro-record, demonstration-mode, auto-author, runs-replay, input-capture, macro-by-example, agent-self-extending, capacity-expansion, macro-registry, registry.json, eos-laptop-agent macros, programming-by-demonstration, repeated-input-sequence. Pattern: Macros: hand-coded now, recorded by Tate next, auto-authored from runs after that.
---
