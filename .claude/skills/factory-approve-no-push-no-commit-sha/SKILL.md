---
name: factory-approve-no-push-no-commit-sha
description: >
  Use when the turn involves approve-factory-deploy, approve_factory_deploy, commit_sha, deploy_status, factory-no-push, origin-drift, cc_sessions, manual-reconcile, factory-state-drift, approve-pipeline-bug. Pattern: Factory approve returns success but does not push or populate commit_sha.
---
