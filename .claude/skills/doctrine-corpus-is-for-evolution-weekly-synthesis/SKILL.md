---
name: doctrine-corpus-is-for-evolution-weekly-synthesis
description: >
  Use when the turn involves doctrine-corpus, weekly-synthesis, doctrine-evolution, pattern-corpus, self-evolution-cadence, episode-mining, log-and-forget, reflexive-doctrine, doctrine-rot, pattern-mining, decision-mining, weekly-cadence, sunday-synthesis. Pattern: Doctrine corpus is for evolution, not archive - weekly synthesis cadence.
---
...
- Status_board row that operationalises an insight (e.g. "Tighten [redacted] invoicing cadence to weekly per Episode 3340 + Episode 3338 cluster").
