---
name: sync-back-must-filter-synthetic-from-source
description: >
  Use when the turn involves sync, trigger, fan-out, synthetic event, event_impact, push-back, duplicate, sync-back, syncToExcel, syncFromExcel, reverse-sync, alias, collective alias, sheet sync, excel-sync. Pattern: Sync-back paths must filter rows that originated from the source they would push back to.
---
