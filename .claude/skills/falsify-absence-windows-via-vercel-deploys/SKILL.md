---
name: falsify-absence-windows-via-vercel-deploys
description: >
  Use when the turn involves tate-absence, kili-window, kili-absence, travel-block, sleep-window, away-from-keyboard, absence-posture, meta-loop-absence, absence-framing, declared-absence, vercel-creator-falsify. Pattern: Falsify declared absence-windows via Vercel deploy creator metadata.
---
