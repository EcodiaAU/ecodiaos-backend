---
name: public-site-wedge-must-surface-in-v1
description: >
  Use when the turn involves marketing-site, public-site-wedge, landing-page-wedge, ecodia-attribution, public-web-wedge, generic-site, bare-site, piercing-wedge-v1, site-rebuild, chambers-platform-site, ecodiasite, ecodia-site, sales-site, marketing-copy-wedge, hero-copy-wedge, b2b-saas-site, site-scaffold-brief. Pattern: Public-facing web properties must surface the piercing wedge in v1, not v2.
---
