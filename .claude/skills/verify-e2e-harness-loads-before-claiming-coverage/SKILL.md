...
description: >
  Use when the turn involves e2e, end-to-end, test:e2e, jest-e2e, test coverage, auth-cognito.e2e-spec, shipped-but-inert, test harness, ordit e2e, client test infra. Pattern: Verify the client's e2e harness actually loads before claiming e2e coverage.
---
