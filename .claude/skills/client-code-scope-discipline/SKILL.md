---
name: client-code-scope-discipline
description: >
  Use when the turn involves (no explicit triggers — surfaces via semantic match on title). Pattern: Client code scope discipline — never expand scope even when Tate says "production ready".
---
...
- If you spot a legitimate infra improvement (migrations, better pipeline, better deploy strategy), **log it as a separate ticket idea in status_board or [redacted].md / {client}.md**. Do not introduce it in the current PR.
...
2026-04-23: [redacted] PR 212 second review. Eugene reviewed and requested changes with direct language: "The AI agent has introduced unplanned, unreviewed infrastructure changes that were not part of this task. Please do not use an AI agent to submit code you have not reviewed line by line."
