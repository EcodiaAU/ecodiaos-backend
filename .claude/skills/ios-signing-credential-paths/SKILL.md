---
name: ios-signing-credential-paths
description: >
  Use when the turn involves ios, xcodebuild, code-signing, provisioning-profile, app-store, asc-api-key, testflight, mac, sy094, exportarchive, manual-signing. Pattern: iOS ship pipeline blocks on signing credentials - pick one of three unblock paths in this order.
---
