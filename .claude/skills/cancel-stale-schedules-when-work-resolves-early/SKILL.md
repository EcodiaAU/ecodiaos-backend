---
name: cancel-stale-schedules-when-work-resolves-early
description: >
  Use when the turn involves schedule_cancel, stale-schedule-cancel, schedule-checkpoint-cancel, review-checkpoint, parallel-resolution-cancel, out-of-band-completion, os_scheduled_tasks-cancel, stale-review-task. Pattern: Cancel stale scheduled tasks the moment the work they track is resolved.
---
