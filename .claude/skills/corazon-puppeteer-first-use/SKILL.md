---
name: corazon-puppeteer-first-use
description: >
  Use when the turn involves corazon, tailscale, puppeteer-first, laptop-agent-default, screenshot.screenshot, visual-verification, admin-ui-puppeteer, oauth-flow-puppeteer, signup-flow-puppeteer, persistent-login, multi-step-web, 100.114.219.69, eos-laptop-agent, mac-agent, sy094, visual-monitoring, curl-alternative, corazon-first. Pattern: Corazon + Puppeteer first, not as a fallback.
---
