---
name: carbon-mrv-wedge-peak-body-sub-commercial
description: >
  Use when the turn involves carbon, mrv, dmrv, accu, peak-body, agriprove, greencollar, fullcam, cer-submission, conservation-platform, soil-carbon, cfi-mer, biodiversity-credit, nature-repair, landcare, nrm, indigenous-carbon. Pattern: Carbon MRV wedge - peak bodies aggregating sub-commercial-scale projects, software-only dMRV at $1.5k/mo.
---
