---
name: sdk-abortcontroller-cancellation
description: >
  Use when the turn involves (no explicit triggers — surfaces via semantic match on title). Pattern: SDK cancellation must use AbortController, not q.close().
---
