---
name: no-pm2-restart-during-active-factory-queue
description: >
  Use when the turn involves pm2-restart, ecodia-api, factory-queue, cleanup-on-shutdown, listener-subsystem-deploy, infrastructure-restart, factory-session-killed. Pattern: Never PM2-restart ecodia-api while Factory sessions are running or queued.
---
