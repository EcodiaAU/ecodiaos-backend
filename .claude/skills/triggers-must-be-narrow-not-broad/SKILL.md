---
name: triggers-must-be-narrow-not-broad
description: >
  Use when the turn involves triggers-frontmatter, narrow-vs-broad-triggers, trigger-keyword-tuning, trigger-false-positive, context-surface-flooding, trigger-discipline, authoring-triggers, trigger-compound-keyword, trigger-literal-id, trigger-bare-noun. Pattern: Triggers must be narrow compounds, literal IDs, or specific names - never bare common nouns.
---
...
3. **Specific person or organisation name.** People who appear as named counterparties or stakeholders. Examples: `eugene`, `kurt`, `[redacted]`, `[redacted]`, `vikki`, `angelica`, `charliebennett`. Specific clients/orgs: `[redacted]`, `coexist`, `landcare`, `chambers`, `[redacted]`, `resonaverde`. (These are narrow because they only appear in briefs about that specific entity.)
