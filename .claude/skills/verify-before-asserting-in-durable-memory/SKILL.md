---
name: verify-before-asserting-in-durable-memory
description: >
  Use when the turn involves graph_reflect, durable-memory-write, durable-assertion, zero-count-claim, null-count-claim, kv_store-handoff, memory-integrity, verify-before-asserting. Pattern: Verify counts and facts before asserting them in a durable memory node.
---
