---
name: excel-sync-collectives-migration
description: >
  Use when the turn involves excel-sync, forms-migrated-at, coexist-collective-migration, coexist-sheet-sync, coexist-forms-to-app-migration, forms_migrated_at. Pattern: Co-Exist Forms → App migration: `forms_migrated_at` is the only switch, and it is explicit per-collective.
---
