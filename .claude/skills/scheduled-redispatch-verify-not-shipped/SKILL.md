---
name: scheduled-redispatch-verify-not-shipped
description: >
  Use when the turn involves scheduled-task, redispatch, factory-redispatch, queued-retry, schedule_delayed, stale-doctrine, parallel-path, ccbe84bd, scheduler-trio, kv_store-prompt, ground-truth-check, factory-no-op-prevention. Pattern: Scheduled redispatch tasks must verify the work has not shipped via another path before firing.
---
