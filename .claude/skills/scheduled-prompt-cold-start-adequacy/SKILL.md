---
name: scheduled-prompt-cold-start-adequacy
description: >
  Use when the turn involves (no explicit triggers — surfaces via semantic match on title). Pattern: Scheduled prompts must pass the 5-gate cold-start check BEFORE the schedule call lands.
---
