---
name: trace-user-ui-report-to-component-before-dispatch
description: >
  Use when the turn involves ui-bug, jess, kurt, tate-relayed-bug, user-reported, ui-report, screen-doesn't-show, missing-from-map, blank-page, doesn't-work, broken-display, member-side, admin-side, visible-bug, render-bug, page-name-assumption, /map, /events, route-vs-component. Pattern: Trace user UI bug reports to the actual component path BEFORE dispatching a fix.
---
