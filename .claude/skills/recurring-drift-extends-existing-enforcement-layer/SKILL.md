---
name: recurring-drift-extends-existing-enforcement-layer
description: >
  Use when the turn involves recurring-drift, mechanical-enforcement-extend, cron-extension, parallel-cron, factory-dispatch-decision, drift-correction, enforcement-layer-extend, queueing-is-not-a-verb, build-vs-extend, third-time-failure. Pattern: Recurring drift extends an existing enforcement layer - never build a parallel one.
---
